...
class BackendRoleController extends Controller
{
    ...
    {
        // $permission = Permission::firstOrCreate(['name' => 'offers-read','table'=>'offers']);
        // $permission = Permission::firstOrCreate(['name' => 'offers-create','table'=>'offers']);
        // $permission = Permission::firstOrCreate(['name' => 'offers-update','table'=>'offers']);
        // $permission = Permission::firstOrCreate(['name' => 'offers-delete','table'=>'offers']);
